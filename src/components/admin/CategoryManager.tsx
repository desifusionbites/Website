...
import { Plus, Edit2, Trash2, Layers, Loader2, CheckCircle2, AlertCircle, Upload } from 'lucide-react';
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl border border-stone-300 text-xs"
                />
                <label className="shrink-0 inline-flex items-center gap-1.5 px-3 py-2 bg-sand-100 hover:bg-sand-200 text-stone-800 rounded-xl text-xs font-semibold cursor-pointer border border-stone-300 transition-colors">
              ...
              {imageUrl && (
                <div className="relative w-20 h-20 rounded-xl overflow-hidden border border-stone-200 bg-sand-50">
