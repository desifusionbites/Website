...
import { Lock, Mail, User, Loader2, AlertCircle, Sparkles, UserCheck, LogIn, CheckCircle2, Eye, EyeOff } from 'lucide-react';
...
function SignUpForm() {
  ...
  async function handleGoogleLogin() {
    ...
    try {
      const supabase = createClient();
      const redirectPath = getSafeRedirectPath(searchParams.get('redirect'), '/account');
      ...
      <>
        ...
        <div className="relative my-2">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white px-2 text-stone-400 font-semibold tracking-wider">or sign up with email</span>
          </div>
        </div>
