...
import { Lock, Mail, Loader2, AlertCircle, UserPlus, LogIn, Sparkles, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="bg-white py-8 px-6 sm:px-10 shadow-xl rounded-3xl border border-sand-200 space-y-6">
      ...
      <div className="relative my-2">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-white px-2 text-stone-400 font-semibold tracking-wider">or sign in with email</span>
        </div>
      </div>
